== rest-generator
:idprefix: id_ 
(choose one, do not modify, then add a second sentence with a brief description, starting with - "The rest-generator addon enables blah blah...)
...
----
<dependency>
   <groupId>org.jjflyboy.forge.addon.rest</groupId>
